...
## Installation
1. Clone this repository to your local machine: https://github.com/Shachar-Oron/Eye_movements_Analysis_tool.git
...
1. Clone the repository to your local machine:
 ```bash
git clone https://github.com/Shachar-Oron/Eye_movements_Analysis_tool.git
```
2. Navigate to the project directory:
 ```bash
cd FinalProject
